...
@section('content')
@inject('encrypt', 'App\Models\Invoice')
       ...
       // $tempcode=$invoice->tempcode;
         ...
         <tr> <td colspan="5"> <strong> Subtotal</strong></td>
          ...
          <tr> <td colspan="5"> <strong> Tax Ppn ({{$taxfee}}%)</strong>
           ...
           <button type="button" class="float-right btn p-2  bg-gradient-primary btn-sm btn-primary mb-2" data-toggle="modal" data-target="#modal-payment">  BAYAR </button>
    ...
    <div class="modal-content ">
           ...
           <div class="modal-body ">
             <div class="content-header">
              ...
              <div class="">
                <div class="card-header">
                  <h3 class="card-title font-weight-bold"> Bayar  </h3>
                </div>
                ...
                <form role="form" method="post" action="/suminvoice/{{$suminvoice_number->id }} ">
                  ...
                  <div class="card-body row">
                    <div class="form-group m-0 col-md-12">
                      ...
                      <span class=" badge badge-primary" {{ $customer->id}}"><strong>{{$customer->customer_id}} ( {{$customer->name}} )</strong></span></br>
                        <label for="description">Address#</label>  {{$customer->address}}
                        <br/>
                     ...
                     <strong> <a>{{$suminvoice_number->number}} </a> </strong>
<hr>
                    </div>
                    ...
                    <div class="form-group m-0 col-md-6">
                      ...
                      <div class="input-group mb-3">
                        <input type="hidden" class="form-control @error('reciece_payment') is-invalid @enderror " name="recieve_payment" id="reciece_payment"  placeholder="Rp. XXXX.XXXX" value="{{$total}}">
                    @error('amount')
  ...
  <div class="form-group col-md-6">
                      <label for="payment_point">Payment Point</label>
                       <input type="hidden" readonly class="form-control " name="payment_point" id="payment_point"   value="{{ Auth::user()->name }}">
